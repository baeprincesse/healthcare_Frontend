...
import { FileText, RefreshCw, Shield, ShieldCheck, ShieldX, Users, XCircle } from "lucide-react";
import api from "../services/api.js";

function PatientCard({ patient, onRequestAccess, loading }) {
...
export default function DoctorPatientsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <p className="text-sm font-semibold text-emerald-600">Patients</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Summary icon={Users} label="Total Patients" value={patients.length} />
        <Summary icon={ShieldCheck} label="Authorized" value={authorizedCount} />
        <Summary icon={ShieldX} label="Pending" value={pendingCount} />
        <Summary icon={Shield} label="No Access" value={noAccessCount} />
      </div>
        ...
        <div className="flex flex-col justify-between gap-2 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              All patients you have appointments with. Request access to view their medical records.
            </p>
          </div>
        ...
        <div className="mt-6">
          {loading ? (
            ...
            <div className="rounded-2xl border border-dashed border-gray-200 bg-gray-50 p-12 text-center">
              <Users className="mx-auto text-gray-400" size={38} />
